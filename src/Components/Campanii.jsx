  ...
  return (
    <div style={{ padding: m ? "18px 14px 28px" : "28px 32px" }}>
      <header style={{ marginBottom: 24, display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
        <div>
          <div style={{ fontSize: 24, fontWeight: 800, color: "var(--text-primary)", marginBottom: 4 }}>Campanii de marketing</div>
  ...
  return (
    <form onSubmit={submit} style={{ ...card, padding: 18 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: m ? "1fr" : "1fr 1fr 1fr", gap: 10 }}>
        ...
        <button type="submit" style={{ gridColumn: m ? "span 1" : "span 3", border: "none", borderRadius: 10, background: "var(--primary)", color: "#fff", fontWeight: 600, cursor: "pointer", fontSize: 13, padding: "11px 14px" }}>Adaugă campanie</button>
      </div>
    </form>
  );
}
