...
export default function AdaugaProprietate() {
  ...
  const handlePublish = async () => {
    ...
    const proprietateData = {
      ...
      status: date.status_proprietate === "vandut" || date.status_proprietate === "inchiriat" ? date.status_proprietate : "activ",
      status_proprietate: date.status_proprietate || "disponibil",
